...
(function ($) {
	...
	$.fn.onScreenKeyboard = function (options) {
		...
		$keyboard.on('click', 'li', function () {
			...
			var hideKeyboard = setTimeout(function () {
	...
	function renderKeyboard(keyboardId) {
		...
		$keyboard = $(
			'<ul id="' + keyboardId + '" oncontextmenu="return(false);">' +
				...
				'<li class="osk-symbol">' +
					...
					'<span class="osk-on">+</span>' +
				'</li>' +
				'<li class="osk-backspace osk-last-item" oncontextmenu="clearField();">backspace</li>' +
